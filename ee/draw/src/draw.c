...
qword_t *draw_enable_tests(qword_t *q, int context, zbuffer_t *z)
{
    ...
    PACK_GIFTAG(q, GIF_SET_TAG(1, 0, 0, 0, GIF_FLG_PACKED, 1), GIF_REG_AD);
    q++;
    PACK_GIFTAG(q, GS_SET_TEST(DRAW_ENABLE, ATEST_METHOD_NOTEQUAL, 0x00, ATEST_KEEP_FRAMEBUFFER, DRAW_DISABLE, DRAW_DISABLE, DRAW_ENABLE, z->method), GS_REG_TEST + context);
    q++;
