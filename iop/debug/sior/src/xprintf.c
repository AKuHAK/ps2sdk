...
int vxprintf(func, arg, format, ap) void (*func)(char *, int, void *);
void *arg;
const char *format;
va_list ap;
{
...
{               /* Describes the string being written to */
...
#ifdef F___sout
void __sout(txt, amt, arg) char *txt;
int amt;
void *arg;
{
    register char *head;
...
#ifdef F_sprintf
__attribute__((weak)) int sprintf(char *str, const char *format, ...)
{
    va_list args;
    struct s_strargument arg;
    int ret;
...
** write in progress
*/
__attribute__((weak)) struct sgMprintf
{
...
void __mout(zNewText, nNewChar, arg) char *zNewText;
int nNewChar;
void *arg;
{
...
#ifdef F___fout
void __fout(zNewText, nNewChar, arg) char *zNewText;
int nNewChar;
void *arg;
{
